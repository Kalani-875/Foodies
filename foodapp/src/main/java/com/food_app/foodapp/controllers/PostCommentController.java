...
public class PostCommentController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<PostComment> updatePost(@PathVariable String id, @RequestBody PostComment post) {
        PostComment updatedPost = postCommentService.update(id, post);
